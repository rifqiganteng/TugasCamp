...
public class Airplane {
    ...
    protected Integer pushEngine;
    //protected Integer nilai;

    //konstruktor
    //public Airplane(Double F1, Double F2, Integer speedTween, Integer speedSingle, Integer pushengine){
        public Airplane(Double F1, Double F2, Integer pushengine){
        this.F1 = F1;
        this.F2 = F2;
